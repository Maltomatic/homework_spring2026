...
def run_training_loop(logger, args):
    ...
    print(f"Action space is {'discrete' if discrete else 'continuous'}.")
    ...
    for itr in range(args.n_iter):
        print(f"\n********** Iteration {itr} ************")
        # TODO(V): sample `args.batch_size` transitions using utils.sample_trajectories
        ...
        # TODO(?V): train the agent using the sampled trajectories and the agent's update function
