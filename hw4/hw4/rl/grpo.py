    ...
    def update(
        ...
        for _ in range(cfg.ppo_epochs):
            for mb in iter_minibatches(
                ...
                # TODO(?V)(student): compute the GRPO minibatch quantities used by the
                ...
                clip_pos = ((ratio < (1.0 - cfg.clip_eps)) | (ratio > (1.0 + cfg.clip_eps))).float() * mask
                clipfrac = masked_mean(clip_pos, mask)
